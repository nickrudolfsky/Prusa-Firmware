...
#define Z_MAX_POS 210 // what should this be for volcano? skelestruder has 220 but that might be for non-volcano
...
#else
#define HEATER_0_MAXTEMP 285 // NR make temp for my thermistor
#endif
